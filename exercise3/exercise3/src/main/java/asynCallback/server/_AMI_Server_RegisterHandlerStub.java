...
public class _AMI_Server_RegisterHandlerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements asynCallback.server.AMI_Server_RegisterHandler
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = asynCallback.server.AMI_Server_RegisterHandlerOperations.class;
	public void register_stock_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "register_stock_excep", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "register_stock_excep", _opsClass );
			if( _so == null )
				continue;
			AMI_Server_RegisterHandlerOperations _localServant = (AMI_Server_RegisterHandlerOperations)_so.servant;
			try
			{
				_localServant.register_stock_excep(excep_holder);
	...
	public void unregister_stock()
	{
		...
		else
		{
			...
			try
			{
				_localServant.unregister_stock();
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void unregister_stock_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "unregister_stock_excep", true);
					((org.omg.CORBA_2_3.portable.OutputStream)_os).write_value (excep_holder );
					_is = _invoke(_os);
					return;
				}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "unregister_stock_excep", _opsClass );
			if( _so == null )
				continue;
			AMI_Server_RegisterHandlerOperations _localServant = (AMI_Server_RegisterHandlerOperations)_so.servant;
			try
			{
				_localServant.unregister_stock_excep(excep_holder);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
